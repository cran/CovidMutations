...
#'
#' @format A dataframe with 394 rows and 10 columns.
#'
#' @keywords datasets
#'
...
#' @usage data(nucmer)
#'
#' @format A dataframe with 437 rows (mutation sites) and 14 columns.
#'
#' @keywords datasets
#'
#' @source \url{https://www.gisaid.org/}
...
#' @usage data(nucmerr)
#'
#' @format A dataframe with 437 rows (downsampled mutation sites) and 10
#' columns.
#'
#' @keywords datasets
#'
